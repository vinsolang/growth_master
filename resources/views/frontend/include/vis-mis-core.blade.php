<div class="w-full mx-auto flex flex-col md:flex-row justify-center items-start space-x-6 space-y-12 px-4">
    ...
    <div class="space-y-2 relative top-4">
        <div class="flex flex-col justify-center items-center">
           <!-- Vision SVG Icon -->
            ...
            <h1 class="text-3xl md:text-4xl font-bold text-left text-blue-900">{{ $getContent[0]->title_v }}</h1>
        </div>
    ...
    <div class="space-y-2">
        <div class="flex flex-col justify-center items-center">
            ...
            <h1 class="text-3xl md:text-4xl font-bold text-left text-blue-900">{{ $getContent[0]->title_m }}</h1>
        </div>
        <p class="max-w-xl text-xl text-blue-900">
...
<div class="px-8">
    <div class="flex flex-col justify-center items-center">
        ...
        <h1 class="text-3xl md:text-4xl font-bold text-left text-blue-900">{{ $getContent[0]->title_c }}
    </div>
    <!-- Grid -->
    <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-start">
        ...
        <div class="bg-white rounded-2xl p-6 ">
            <h2 class="text-2xl font-bold text-blue-900 mb-3">{{ $getContent[0]->sub_t_1 }}</h2>
        ...
        <!-- H -->
        <div class="bg-white rounded-2xl p-6 ">
            <h2 class="text-2xl font-bold text-blue-900 mb-3">{{ $getContent[0]->sub_t_2 }}</h2>
            <p class="text-xl text-blue-900">
        ...
        <!-- A -->
        <div class="bg-white rounded-2xl p-6 ">
            <h2 class="text-2xl font-bold text-blue-900 mb-3">{{ $getContent[0]->sub_t_3 }}</h2>
            <p class="text-xl text-blue-900">
        ...
        <!-- R -->
        <div class="bg-white rounded-2xl p-6 ">
            <h2 class="text-2xl font-bold text-blue-900 mb-3">{{ $getContent[0]->sub_t_4 }}</h2>
            <p class="text-xl text-blue-900">
        ...
        <div class="bg-white rounded-2xl p-6  md:col-span-2 lg:col-span-1">
            <h2 class="text-2xl font-bold text-blue-900 mb-3">{{ $getContent[0]->sub_t_5 }}</h2>
            <p class="text-xl text-blue-900">
