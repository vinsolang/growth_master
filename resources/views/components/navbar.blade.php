<nav id="navbar" class="py-4 px-6 shadow-lg bg-black/40 fixed top-0 right-0 left-0 z-50 transition-all duration-300">
    <div class="flex justify-between items-center">
        ...
        <div class="flex items-center gap-3">
            ...
            <!-- Desktop Menu -->
            <ul class="hidden xl:flex gap-10 text-white text-[17px]" id="navLinks">
                <li class="group relative hover:text-[#EDC11C] cursor-pointer">
                    ...
                    <div class="absolute left-0 mt-0 w-52 hidden group-hover:block z-10">
                        <div class="bg-[#003F5F] text-white mt-10 text-[14px]">
                            <a href="{{URL('/membership')}}" class="block px-4 py-2 hover:text-[#003F5F] hover:bg-[#c3d1d9]">Why Join GrowthMaster</a>
                            <a href="{{ route('approach') }}" class="block px-4 py-2 hover:text-[#003F5F] hover:bg-[#c3d1d9]">Our Approach</a>
                            <a href="{{ route('program') }}" class="block px-4 py-2 hover:text-[#003F5F] hover:bg-[#c3d1d9]">Our Programs</a>
                            <a href="{{ route('review') }}" class="block px-4 py-2 hover:text-[#003F5F] hover:bg-[#c3d1d9]">GrowthMaster Reviews</a>
                            <a href="#" class="block px-4 py-2 hover:text-[#003F5F] hover:bg-[#c3d1d9]">Exclusive Peer Groups</a>
                            <a href="{{ route('application') }}" class="block px-4 py-2 hover:text-[#003F5F] hover:bg-[#c3d1d9]">Become a Member</a>
                        </div>   
                    </div>
                </li>
                <li class="group relative hover:text-[#EDC11C] cursor-pointer">
                    ...
                    <div class="absolute left-0 mt-0 w-52 hidden group-hover:block z-10">
                        <div class="bg-[#003F5F] text-white mt-10 text-[14px]">
                            <a href="{{ route('events') }}" class="block px-4 py-2 hover:text-[#003F5F] hover:bg-[#c3d1d9]">GrowthMaster Event</a>
                            <a href="{{ route('ceo.climb.events') }}" class="block px-4 py-2 hover:text-[#003F5F] hover:bg-[#c3d1d9]">GrowthMaster CEO Climb Event</a>
                            <a href="{{ route('research.center.webinar') }}" class="block px-4 py-2 hover:text-[#003F5F] hover:bg-[#c3d1d9]">GrowthMaster webinars</a>
                        </div>
                    </div>
                </li>
        ...
        <div class="flex items-center gap-5">
            <button class="py-4 px-6 bg-[#EDC11C] text-[#003F5F] hover:bg-[#003F5F] hover:text-white hidden md:block rounded font-medium">
                Become a Member
            </button>
    ...
    <!-- Mobile Menu -->
    <ul id="mobileMenu" class="xl:hidden hidden flex-col gap-4 mt-5 text-[17px] text-black">
        <li class="hover:text-blue-600 cursor-pointer">Membership</li>
        <li class="hover:text-blue-600 cursor-pointer">Events</li>
        <li class="hover:text-blue-600 cursor-pointer">Resources</li>
        <li class="hover:text-blue-600 cursor-pointer">About</li>
        <li class="hover:text-blue-600 cursor-pointer">Chair</li>
    </ul>
</nav>
