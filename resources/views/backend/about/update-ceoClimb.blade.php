    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                ...
                <!-- File input -->
                <form action="{{ route('submit.c_e_o_climbs') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                                ...
                                <div class="mb-3 col-12 border border-[#0F4634]">
                                    ...
                                    <div class="mb-3 col-12">
                                        <textarea name="description" class="form-control" id="description"
                                            placeholder="Description">{{ $ceo->description }}</textarea>
                                    </div>
                                    <div class="mb-3 col-12">
                                        <textarea name="title" class="form-control" id="title"
                                            placeholder="title">{{ $ceo->title }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 col-12 border border-[#0F4634]">
                                    ...
                                    <div class="mb-3 col-12">
                                        <input class="form-control" type="text" name="title_card_1"
                                            value="{{ $ceo->title_card_1 }}" placeholder="Title" />
                                    </div>
                                    <div class="mb-3 col-12">
                                        <textarea name="desc_card_1" class="form-control" id="desc_card_1"
                                            placeholder="Description">{{ $ceo->desc_card_1 }}</textarea>
                                    </div>
                                    <div class="mb-3 col-12">
                                 ...
                                 <div class="mb-3 col-12 border border-[#0F4634]">
                                    ...
                                    <div class="mb-3 col-12">
                                        <input class="form-control" type="text" name="title_card_2"
                                            value="{{ $ceo->title_card_2 }}" placeholder="Title" />
                                    </div>
                                    <div class="mb-3 col-12">
                                        <textarea name="desc_card_2" class="form-control" id="desc_card_2"
                                            placeholder="Description">{{ $ceo->desc_card_2 }}</textarea>
                                    </div>
                                    <div class="mb-3 col-12">
                                  ...
                                  <div class="mb-3 col-12 border border-[#0F4634]">
                                    ...
                                    <div class="mb-3 col-12">
                                        <input class="form-control" type="text" name="title_card_3"
                                            value="{{ $ceo->title_card_3 }}" placeholder="Title" />
                                    </div>
                                    <div class="mb-3 col-12">
                                        <textarea name="desc_card_3" class="form-control" id="desc_card_3"
                                            placeholder="Description">{{ $ceo->desc_card_3 }}</textarea>
                                    </div>
                                    <div class="mb-3 col-12">
...
document.getElementById('img_card_3').addEventListener('change', function(e){
    ...
    if(file){
        ...
        preview.style.display = '{{ isset($leaderships->img_card_3) ? 'block' : 'none' }}';
    }
});
</script>
@endsection