    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                ...
                <!-- File input -->
                <form action="{{ route('submit.accounting.admin') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-12 border border-[#0F4634] p-3">
                                    ...
                                    <div id="block-wrapper">
                                        ...
                                        @if(!empty($ceo->title_card))
                                            @foreach($ceo->title_card as $i => $title)
                                            <div class="block-item border p-3 mb-3 rounded">
                                                ...
                                                <textarea name="desc_card[]"
                                                    class="form-control mb-2"
                                                    placeholder="Description">{{ $ceo->desc_card[$i] ?? '' }}</textarea>

                                                <img
                                                    src="{{ isset($ceo->img_card[$i]) ? asset($ceo->img_card[$i]) : '' }}"
                                                    width="120"
                                                    class="preview mb-2"
                                                    style="display: {{ isset($ceo->img_card[$i]) ? 'block' : 'none' }}">
