      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul  class="menu-inner py-1">
          ...
          <li class="menu-item">
           ...
           <!-- Layouts -->
          <li class="menu-item">
            <a href="{{ route('become.index') }}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-group"></i>
           ...
           <!-- Layouts -->
          <li class="menu-item">
            <a href="{{ route('licensee.index') }}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-group"></i>
          ...
          <li class="menu-item">
           ...
           <li class="menu-item">
            <a href="{{ route('referralprogram.index') }}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-group"></i>
...
{{-- ========================================================================= --}}
          ...
          {{-- <li class="menu-item">
            ...
            <ul class="menu-sub">
              ...
              <li class="menu-item">
                <a href="{{ route('helpsction.create') }}" class="menu-link">
          ...
          {{-- <li class="menu-item">
            ...
            <ul class="menu-sub">
              ...
              <li class="menu-item">
                <a href="{{ route('add_faqs') }}" class="menu-link">
          ...
          {{-- <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="" class="menu-link">
                  <div data-i18n="Without menu">View Services</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="" class="menu-link">
