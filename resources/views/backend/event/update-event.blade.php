                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-12">
                                 ...
                                 <div class="mb-3 col-12">
                                    ...
                                    <input class="form-control" type="date" name="event_date" value="{{ \Carbon\Carbon::parse($event->event_date)->format('Y-m-d') }}" placeholder="10/Jan/2026"/>
                                </div>
                            ...
                            <div class="row border border-[#0F4634]">
                                <div class="mb-3 col-12">
                                    ...
                                    <input class="form-control" type="text" name="title_overview" value="{{ $event->title_overview }}"/>
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Description</label>
                                    <textarea name="description_overview" class="form-control" id="description_overview">{{ $event->description_overview }}</textarea>
                                </div>
                                    ...
                                    <div class="mb-3 col-12">
                                        <div class="mb-2">
                                            <img id="previewimg_details"
                                                src="{{ isset($event->img_details) ? asset($event->img_details) : '' }}"
                                                width="150"
                                                class="rounded border"
                                                style="display: {{ isset($event->img_details) ? 'block' : 'none' }};">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <textarea name="content_card_1" class="form-control" id="content_card_1">{!! $event->content_card_1 !!}</textarea>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="content_card_2" class="form-label text-[#0F4634]">Content 2</label>
                                        <textarea name="content_card_2" class="form-control" id="content_card_2">{!! $event->content_card_2 !!}</textarea>
                                    </div>

                                    <!-- Row 2 -->
                                    <div class="mb-3 col-md-6">
                                        <label for="content_card_3" class="form-label text-[#0F4634]">Content 3</label>
                                        <textarea name="content_card_3" class="form-control" id="content_card_3">{!! $event->content_card_3 !!}</textarea>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="content_card_4" class="form-label text-[#0F4634]">Content 4</label>
                                        <textarea name="content_card_4" class="form-control" id="content_card_4">{!! $event->content_card_4 !!}</textarea>
                                    </div>
                                </div>
                               ...
                               <div class="mb-3 col-12">
                                    ...
                                    <div class="d-flex flex-row flex-wrap" id="preview_container">
                                        {{-- Existing images --}}
                                        @if(isset($event->img_limit_3) && is_array($event->img_limit_3))
                                            @foreach($event->img_limit_3 as $index => $img)
                                                <div class="position-relative me-2 mb-2" style="width:150px;">
                                                    <img src="{{ asset($img) }}" class="rounded border w-full h-full object-cover">
                                            ...
                                            @endforeach
                                        @elseif(isset($event->img_limit_3))
                                            <div class="position-relative me-2 mb-2" style="width:150px;">
                                                <img src="{{ asset($event->img_limit_3) }}" class="rounded border w-100">
                                                <button type="button" class="btn btn-sm btn-danger position-absolute top-0 end-0 remove-img-btn">&times;</button>
                                                <input type="hidden" name="existing_img_limit_3[]" value="{{ $event->img_limit_3 }}">
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea name="desc_overview" class="form-control" id="desc_overview">{!! $event->desc_overview !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row border border-[#0F4634]">
                                <div class="mb-3 col-12">
                                    ...
                                    <input type="text" name="title_details" class="form-control" value="{{ $event->title_details }}"/>
                                </div>
                                <div class="mb-3">

                                    <div id="details_container">

                                        @if(isset($event->name_details) && is_array($event->name_details))
                                            @foreach($event->name_details as $index => $name)
                                            ...
                                            <div class="row border border-[#0F4634] p-3 mb-3 detail-item">
                                                ...
                                                <div class="mb-3 col-12">
                                                    ...
                                                    <textarea name="position_details[]" class="form-control">{!! $event->position_details[$index] ?? '' !!}</textarea>
                                                </div>

                                                <!-- Bio -->
                                                <div class="mb-3 col-12">
                                                    <label class="form-label text-[#0F4634]">Bio / Description</label>
                                                    <textarea name="bio_details[]" class="form-control">{{ $event->bio_details[$index] ?? '' }}</textarea>
                                                </div>
                                                ...
                                                <div class="mb-3 col-12">
                                                    ...
                                                    <div class="mb-2">
                                                        <img
                                                            ...
                                                            width="150"
                                                            src="{{ isset($event->profile_image[$index]) ? asset($event->profile_image[$index]) : '' }}"
                                                            style="display: {{ isset($event->profile_image[$index]) ? 'block' : 'none' }};">
                                                    </div>
                                                    ...
                                                    <input type="hidden" name="old_profile_image[]" 
                                                        value="{{ $event->profile_image[$index] ?? '' }}">
                                                </div>
                            ...
                            <div class="row border border-[#0F4634] p-4">
                                <div class="mb-3 col-12">
                                    <label class="form-label text-[#0F4634] text-xl">Title</label>
                                    <input type="text" name="title_agenda" class="form-control" value="{{ $event->title_agenda }}"/>
                                </div>
                               <div id="event-wrapper">
                                    @if(isset($event->agenda_items) && is_array($event->agenda_items))

                                        @foreach($event->agenda_items as $index => $ev)
                            ...
                            <div class="row border border-[#0F4634] p-4">
                                <div class="mb-3 col-12">
                                    <label class="form-label text-[#0F4634] text-xl">Title</label>
                                    <input type="text" name="title_breakout" class="form-control" value="{{ $event->title_breakout }}"/>
                                </div>

                                <div id="breakout-wrapper">
                                    @if(isset($event->breakout_items) && is_array($event->breakout_items))
                                        @foreach($event->breakout_items as $index => $ev)
                                            <div class="border p-4 mb-4 rounded position-relative breakout-item">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" 
                                                        name="breakout_items[{{ $index }}][date]" 
                                                        class="form-control"
                                                        value="{{ $ev['date'] ?? '' }}" />
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label text-[#0F4634]">Description</label>
                                                    <textarea name="breakout_items[{{ $index }}][description]" 
                                                        id="description_breakout_{{ $index }}" 
                            ...
                            <div class="row border border-[#0F4634] p-4">
                                ...
                                <div class="mb-3 col-12">
                                    <label class="form-label text-[#0F4634] text-xl">Title</label>
                                    <input type="text" name="title_sponsor" class="form-control" value="{{ $event->title_sponsor }}"/>
                                </div>
                               ...
                               <!-- Upload -->
                                ...
                                <div id="sponsor-preview" class="d-flex flex-wrap gap-3 mt-3">
                                    @if(isset($event->sponsor_logos) && is_array($event->sponsor_logos))
                                        @foreach($event->sponsor_logos as $logo)
                                            <div class="position-relative" style="width:120px;">
                                                <img src="{{ asset($logo) }}" class="rounded border w-full h-full object-cover" />
                            ...
                            <div class="row border border-[#0F4634] p-4">
                                ...
                                <div class="mb-3 col-12">
                                    <label class="form-label text-[#0F4634] text-xl">Title</label>
                                    <input type="text" name="title_location" class="form-control" value="{{ $event->title_location }}"/>
                                </div>

                                <div class="mb-3 col-12">
                                    <label class="form-label text-[#0F4634]">Link Of Location</label>
                                    <input type="text" name="location_link" class="form-control" value="{{ $event->location_link }}"/>
                                </div>
...
<script>
    // let breakoutIndex = 0;
    let breakoutIndex = {{ isset($event->breakout_items) ? count($event->breakout_items) : 0 }};
