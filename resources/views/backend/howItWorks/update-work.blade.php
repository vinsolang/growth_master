                ...
                <form action="{{ route('work.update', $work->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <input type="hidden" name="update_id" value="{{ $work->id }}">
                                    ...
                                    <div class="flex">
                                        <label class="uploader relative flex flex-col items-center justify-center 
                                            ...
                                            <img 
                                                ...
                                                {{ $work->image ? '' : 'hidden' }}"
                                                src="{{ $work->image ? asset('assets/how_it_work/'.$work->image) : '' }}"
                                            />
                                            ...
                                            <button type="button"
                                                ...
                                                {{ $work->image ? '' : 'hidden' }}">✕</button>

                                            <!-- Hidden Old Image -->
                                            <input type="hidden" name="old_image" value="{{ $work->image }}">
