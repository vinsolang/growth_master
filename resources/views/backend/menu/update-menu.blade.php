    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                ...
                @endif
                <!-- File input -->
                <form action="{{ route('submit.menu') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4 border border-green-400 p-2">
                                    ...
                                    <input class="form-control mb-2" type="text" name="menu_2" value="{{ $menu->menu_2 }}"
                                        placeholder="menu" />
                                    <input class="form-control mb-2" type="text" name="menu_3" value="{{ $menu->menu_3 }}"
                                        placeholder="menu" />
                                    <input class="form-control mb-2" type="text" name="menu_4" value="{{ $menu->menu_4 }}"
                                        placeholder="menu" />
                                    <input class="form-control mb-2" type="text" name="menu_5" value="{{ $menu->menu_5 }}"
                                        placeholder="menu" />
                                    <input class="form-control mb-2" type="text" name="menu_6" value="{{ $menu->menu_6 }}"
                                        placeholder="menu" />
                                </div>
                                ...
                                <div class="col-md-6 mb-4 border border-green-400 p-2">
                                    ...
                                    <label class="form-label text-[#0F4634]">Menu dropdown</label>
                                    <input class="form-control mb-2" type="text" name="menu_8" value="{{ $menu->menu_8 }}"
                                        placeholder="menu" />
                                    <input class="form-control mb-2" type="text" name="menu_9" value="{{ $menu->menu_9 }}"
                                        placeholder="menu" />
                                    <input class="form-control mb-2" type="text" name="menu_10" value="{{ $menu->menu_10 }}"
                                        placeholder="menu" />
                                </div>
                                ...
                                <div class="col-md-6 mb-4 border border-green-400 p-2">
                                    ...
                                    <input class="form-control mb-2" type="text" name="menu_14" value="{{ $menu->menu_14 }}"
                                        placeholder="menu" />
                                    <input class="form-control mb-2" type="text" name="menu_15" value="{{ $menu->menu_15 }}"
                                        placeholder="menu" />
                                </div>
                                ...
                                <div class="col-md-6 mb-4 border border-green-400 p-2">
                                    ...
                                    <label class="form-label text-[#0F4634]">Menu dropdown</label>
                                    <input class="form-control mb-2" type="text" name="menu_17" value="{{ $menu->menu_17 }}"
                                        placeholder="menu" />
                                    <input class="form-control mb-2" type="text" name="menu_18" value="{{ $menu->menu_18 }}"
                                        placeholder="menu" />
                                    <input class="form-control mb-2" type="text" name="menu_19" value="{{ $menu->menu_19 }}"
                                        placeholder="menu" />
                                </div>
