          ...
          <div class="card-body">
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('submit.login') }}" method="POST">
              ...
              <div class="mb-3 items-center">
                <img src="{{ asset('assets/icon/CAC-02.jpg') }}" alt="" width="100px" height="90px" class="items-center block m-auto">
              </div>
              <div class="mb-3">
            ...
            {{-- <p class="text-center">
              ...
              <a href="{{ route('register') }}">
                <span class="text-[#1B1684] font-bold">Create an account</span>
              </a>
            </p> --}}
          </div>
        </div>
