    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                ...
                <!-- File input -->
                <form action="{{ route('submit.homecontent') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="mb-3 col-12 border border-[#0F4634]">
                                    ...
                                    <div class="mb-3 col-12">
                                        <input class="form-control" type="text" name="title" value="{{ $getSectionHome->title }}"
                                            placeholder="Title" />
                                    </div>
                                    <div class="mb-3 col-12">
                                        <textarea name="description" class="form-control" id="description"
                                            placeholder="Description">{{ $getSectionHome->description }}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <div class="mb-3 col-12">
                                            <textarea name="desc_card_1" class="form-control" id="desc_card_1"
                                                placeholder="Description">{{ $getSectionHome->desc_card_1 }}</textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-12">
                                        ...
                                        <div class="mb-3 col-12">
                                            <input class="form-control" type="text" name="title_card_2"
                                                value="{{ $getSectionHome->title_card_2 }}" placeholder="Title" />
                                        </div>
                                        <div class="mb-3 col-12">
                                            <textarea name="desc_card_2" class="form-control" id="desc_card_2"
                                                placeholder="Description">{{ $getSectionHome->desc_card_2 }}</textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-12">
                                        ...
                                        <div class="mb-3 col-12">
                                            <input class="form-control" type="text" name="title_card_3"
                                                value="{{ $getSectionHome->title_card_3 }}" placeholder="Title" />
                                        </div>
                                        <div class="mb-3 col-12">
                                            <textarea name="desc_card_3" class="form-control" id="desc_card_3"
                                                placeholder="Description">{{ $getSectionHome->desc_card_3 }}</textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-12">
                                        ...
                                        <div class="mb-3 col-12">
                                            <input class="form-control" type="text" name="title_card_4"
                                                value="{{ $getSectionHome->title_card_4 }}" placeholder="Title" />
                                        </div>
                                        <div class="mb-3 col-12">
                                            <textarea name="desc_card_4" class="form-control" id="desc_card_4"
                                                placeholder="Description">{{ $getSectionHome->desc_card_4 }}</textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-12">
                                        ...
                                        <div class="mb-3 col-12">
                                            <input class="form-control" type="text" name="title_card_5"
                                                value="{{ $getSectionHome->title_card_5 }}" placeholder="Title" />
                                        </div>
                                        <div class="mb-3 col-12">
                                            <textarea name="desc_card_5" class="form-control" id="desc_card_5"
                                                placeholder="Description">{{ $getSectionHome->desc_card_5 }}</textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-12">
                                        ...
                                        <div class="mb-3 col-12">
                                            <input class="form-control" type="text" name="title_card_6"
                                                value="{{ $getSectionHome->title_card_6 }}" placeholder="Title" />
                                        </div>
                                        <div class="mb-3 col-12">
                                            <textarea name="desc_card_6" class="form-control" id="desc_card_6"
                                                placeholder="Description">{{ $getSectionHome->desc_card_6 }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 col-12 border border-[#0F4634]">
                                    ...
                                    <div class="mb-3 col-12">
                                        <textarea name="description_1" class="form-control" id="description_1"
                                            placeholder="Description">{{ $getSectionHome->description_1 }}</textarea>
                                    </div>
                                    <div class="mb-3 col-12">
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <div class="mb-3 col-12">
                                            <input class="form-control" type="text" name="title_event_2"
                                                value="{{ $getSectionHome->title_event_2 }}" placeholder="Title" />
                                        </div>
                                        <div class="mb-3 col-12">
                                            <textarea name="desc_card_event_2" class="form-control" id="desc_card_event_2"
                                                placeholder="Description">{{ $getSectionHome->desc_card_event_2 }}</textarea>
                                        </div>
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <div class="mb-3 col-12">
                                            <input class="form-control" type="text" name="title_event_3"
                                                value="{{ $getSectionHome->title_event_3 }}" placeholder="Title" />
                                        </div>
                                        <div class="mb-3 col-12">
                                            <textarea name="desc_card_event_3" class="form-control" id="desc_card_event_3"
                                                placeholder="Description">{{ $getSectionHome->desc_card_event_3 }}</textarea>
                                        </div>
...
document.getElementById('image').addEventListener('change', function(e){
    ...
    if(file){
        ...
        preview.style.display = '{{ isset($getSectionHome->image) ? 'block' : 'none' }}';
    }
});
</script>
<script>
document.getElementById('img_card_event_1').addEventListener('change', function(e){
    ...
    if(file){
        ...
        preview.style.display = '{{ isset($getSectionHome->img_card_event_1) ? 'block' : 'none' }}';
    }
});
</script>
<script>
document.getElementById('img_card_event_2').addEventListener('change', function(e){
    ...
    if(file){
        ...
        preview.style.display = '{{ isset($getSectionHome->img_card_event_2) ? 'block' : 'none' }}';
    }
});
</script>
<script>
document.getElementById('img_card_event_3').addEventListener('change', function(e){
    ...
    if(file){
        ...
        preview.style.display = '{{ isset($getSectionHome->img_card_event_3) ? 'block' : 'none' }}';
    }
});
</script>
