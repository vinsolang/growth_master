                ...
                <form action="{{ route('program.update', $program->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <input type="hidden" name="update_id" value="{{ $program->id }}">
                                 <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Audience</label>
                                    <input class="form-control" type="text" name="audience" value="{{ $program->audience }}" />
                                </div>
                                <div class="mb-3 col-12">
                                ...
                                <div class="mb-3 col-12">
                                    ...
                                    <textarea name="description" class="form-control" id="description" rows="6">{{ $program->description }}</textarea>
                                </div>
                                 <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Text Of Button</label>
                                    <textarea name="button_text" class="form-control" id="button_text">{{ $program->button_text }}</textarea>
                                </div>
                                    ...
                                    <div class="flex">
                                        <label class="uploader relative flex flex-col items-center justify-center 
                                            ...
                                            <img 
                                                ...
                                                {{ $program->image ? '' : 'hidden' }}"
                                                src="{{ $program->image ? asset('assets/our_program/'.$program->image) : '' }}"
                                            />
