    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                ...
                <!-- File input -->
                <form action="{{ route('submit.apply') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                                ...
                                <div class="mb-3 col-12 border border-[#0F4634]">
                                    ...
                                    <div class="mb-3 col-12">
                                        <textarea name="title" class="form-control" id="title"
                                            placeholder="Description">{{ $apply->title }}</textarea>
                                    </div>
                                    <label for="formFile" class="form-label text-[#0F4634]">Title</label>
                                    <div class="mb-3 col-12">
                                        <textarea name="description" class="form-control" id="description"
                                            placeholder="Description">{{ $apply->description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 col-12 border border-[#0F4634]">
                                    ...
                                    <div class="mb-3 col-12">
                                        <textarea name="desc_list" class="form-control" id="desc_list"
                                            placeholder="Description">{{ $apply->desc_list }}</textarea>
                                    </div>
