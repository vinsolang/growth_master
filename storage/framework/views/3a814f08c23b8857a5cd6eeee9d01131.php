                                ...
                                <tr>
                                    <td>
                                        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                            <img src="../assets/banner/<?php echo e($items->image); ?>" alt="Avatar" class="rounded-circle"
                                                style="width: 250px;
                                                                    object-fit: cover;
                                    ...
                                    <td>
                                        <div class="dropdown position-static">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="<?php echo e(route('banner.edit', $items->id)); ?>"><i
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.querySelectorAll(".remove-post-key").forEach(btn => {
            btn.addEventListener("click", function () {
                ...
                document.querySelector("#deleteForm").action = "<?php echo e(url('banner')); ?>" + '/' + id;
            });
        });
    });
</script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Seed Media\Growth_Master\resources\views/backend/banner/view-banner.blade.php ENDPATH**/ ?>