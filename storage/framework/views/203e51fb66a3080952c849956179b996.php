        ...
        <div id="step-1" class="step bg-[#0b2642] md:h-[120vh] flex justify-center text-white py-4">
            <div class="w-full max-w-4xl text-center px-6 space-y-6">
                <a href="<?php echo e(route('home')); ?>">
                    <div class="w-40 h-40">
                        <img src="<?php echo e(asset('assets/logo.png')); ?>" alt="" class="rounded-full">
                    </div>
                </a>
        ...
        <div id="step-2" class="step hidden bg-[#0b2642] md:h-[120vh] justify-center text-white py-4">
            <div class="w-full max-w-4xl text-center px-6 space-y-6">
                ...
                <div class="w-full flex flex-col space-y-4 font-medium placeholder:font-medium">
                    <input name="firstname" type="text" value="<?php echo e(old('firstname')); ?>" placeholder="First name*"
...
unset($__errorArgs, $__bag); ?>
                    <input name="lastname" type="text" value="<?php echo e(old('lastname')); ?>" placeholder="Last name*"
                        class="border border-[#c8bfbf] w-full max-w-2xl h-12 rounded-md bg-transparent px-4 placeholder:font-bold">
        ...
        <div id="step-5" class="step hidden bg-[#0b2642] md:h-[120vh] justify-center text-white py-4">
            <div class="w-full max-w-4xl text-center px-6 space-y-6">
                ...
                <select name="revenue"
                    ...
                    <option value="Less than 500k" <?php echo e(old('revenue') == 'Less than 500k' ? 'selected' : ''); ?>>
                        Less than 500k</option>
                    <option value="500 - 999k" <?php echo e(old('revenue') == '500k' ? 'selected' : ''); ?>>500 - 999k
                    </option>
                    <option value="1-4 Million" <?php echo e(old('revenue') == '1-4 Million' ? 'selected' : ''); ?>>1-4
                        Million</option>
                    <option value="5-9 Million" <?php echo e(old('revenue') == '5-9 Million' ? 'selected' : ''); ?>>5-9
                        Million</option>
                    <option value="10-20 Million" <?php echo e(old('revenue') == '10-20 Million' ? 'selected' : ''); ?>>
                        10-20
                        Million</option>
                    <option value="21-49 Million" <?php echo e(old('revenue') == '21-49 Million' ? 'selected' : ''); ?>>
                        21-49
                        Million</option>
                    <option value="50-99 Million" <?php echo e(old('revenue') == '50-99 Million' ? 'selected' : ''); ?>>
                        50-99
                        Million</option>
                    <option value="100-249 Million" <?php echo e(old('revenue') == '100-249 Million' ? 'selected' : ''); ?>>
                        100-249 Million</option>
                    <option value="250-499 Million" <?php echo e(old('revenue') == '250-499 Million' ? 'selected' : ''); ?>>
                        250-499 Million</option>
                    <option value="500-999 Million" <?php echo e(old('revenue') == '500-999 Million' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <input name="email_refer" type="email" value="<?php echo e(old('email_refer')); ?>"
                            placeholder="Email of person who referred you"
                            class="border border-[#c8bfbf] w-full h-12 rounded-md px-4 focus:outline-none placeholder:font-bold">

                        <?php $__errorArgs = ['email_refer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</html><?php /**PATH D:\Seed Media\Growth_Master\resources\views/frontend/becom-a-member/becom-member.blade.php ENDPATH**/ ?>