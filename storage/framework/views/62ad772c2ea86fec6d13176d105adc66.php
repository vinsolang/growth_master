                                ...
                                <tr>
                                    <td>
                                     ...
                                     <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                        <strong><?php echo e($items->audience); ?></strong>
                                    </td>
                                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                    ...
                                    <td>
                                        <div class="dropdown position-static">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="<?php echo e(route('program.edit', $items->id)); ?>"><i
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.querySelectorAll(".remove-post-key").forEach(btn => {
            btn.addEventListener("click", function () {
                ...
                document.querySelector("#deleteForm").action = "<?php echo e(url('program')); ?>" + '/' + id;
            });
        });
    });
</script>
