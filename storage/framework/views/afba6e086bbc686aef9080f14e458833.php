    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                ...
                <!-- File input -->
                <form action="<?php echo e(route('submit.c_e_o_climbs')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card">
                                ...
                                <div class="mb-3 col-12 border border-[#0F4634]">
                                    ...
                                    <div class="mb-3 col-12">
                                        <input class="form-control" type="text" name="title_card_1"
                                            value="<?php echo e($ceo->title_card_1); ?>" placeholder="Title" />
                                    </div>
                                    <div class="mb-3 col-12">
                                        <textarea name="desc_card_1" class="form-control" id="desc_card_1"
                                            placeholder="Description"><?php echo e($ceo->desc_card_1); ?></textarea>
                                    </div>
                                    <div class="mb-3 col-12">
                                 ...
                                 <div class="mb-3 col-12 border border-[#0F4634]">
                                    ...
                                    <div class="mb-3 col-12">
                                        <input class="form-control" type="text" name="title_card_2"
                                            value="<?php echo e($ceo->title_card_2); ?>" placeholder="Title" />
                                    </div>
                                    <div class="mb-3 col-12">
                                        <textarea name="desc_card_2" class="form-control" id="desc_card_2"
                                            placeholder="Description"><?php echo e($ceo->desc_card_2); ?></textarea>
                                    </div>
                                    <div class="mb-3 col-12">
                                  ...
                                  <div class="mb-3 col-12 border border-[#0F4634]">
                                    <label for="formFile" class="form-label text-[#0F4634]">Block 3</label>
                                    <div class="mb-3 col-12">
                                        <input class="form-control" type="text" name="title_card_3"
                                            value="<?php echo e($ceo->title_card_3); ?>" placeholder="Title" />
                                    </div>
                                    <div class="mb-3 col-12">
                                        <textarea name="desc_card_3" class="form-control" id="desc_card_3"
                                            placeholder="Description"><?php echo e($ceo->desc_card_3); ?></textarea>
                                    </div>
                                    <div class="mb-3 col-12">
...
<script>
document.getElementById('img_card_3').addEventListener('change', function(e){
    const preview = document.getElementById('previewimg_card_3');
    const file = e.target.files[0];

    if(file){
        // Update preview to new img_card_3
        preview.src = URL.createObjectURL(file);
        preview.style.display = 'block';
    } else {
        // Keep old img_card_3 if no file selected
        preview.style.display = '<?php echo e(isset($leaderships->img_card_3) ? 'block' : 'none'); ?>';
    }
});
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Seed Media\Growth_Master\resources\views/backend/about/update-ceoClimb.blade.php ENDPATH**/ ?>