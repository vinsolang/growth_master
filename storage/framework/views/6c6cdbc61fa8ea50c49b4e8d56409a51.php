...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                <!-- File input -->
                <form action="<?php echo e(route('program.update', $program->id)); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <input type="hidden" name="update_id" value="<?php echo e($program->id); ?>">
                                 <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Audience</label>
                                    <input class="form-control" type="text" name="audience" value="<?php echo e($program->audience); ?>" />
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Title</label>
                                    <input class="form-control" type="text" name="title" value="<?php echo e($program->title); ?>" />
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Description</label>
                                    <textarea name="description" class="form-control" id="description" rows="6"><?php echo e($program->description); ?></textarea>
                                </div>
                                 <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Text Of Button</label>
                                    <textarea name="button_text" class="form-control" id="button_text"><?php echo e($program->button_text); ?></textarea>
                                </div>
                                    ...
                                    <div class="flex">
                                        <label class="uploader relative flex flex-col items-center justify-center 
                                            ...
                                            <img 
                                                ...
                                                <?php echo e($program->image ? '' : 'hidden'); ?>"
                                                src="<?php echo e($program->image ? asset('assets/our_program/'.$program->image) : ''); ?>"
                                            />
                                            ...
                                            <button type="button"
                                                ...
                                                <?php echo e($program->image ? '' : 'hidden'); ?>">✕</button>

                                            <!-- Hidden Old Image -->
                                            <input type="hidden" name="old_image" value="<?php echo e($program->image); ?>">
...
<?php echo $__env->make('backend.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Seed Media\Growth_Master\resources\views/backend/our-program/update-program.blade.php ENDPATH**/ ?>