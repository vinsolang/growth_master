...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="col-xl-12">
            ...
            <form action="<?php echo e(route('submit.update.faqs')); ?>" method="post">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <textarea name="question" class="form-control" id="question"><?php echo e($faq->question); ?></textarea>
                            </div>

                            <div class="mb-3 col-12">
                                <label class="form-label text-[#0F4634]">Answer</label>
                                <textarea name="answer" class="form-control" id="answer" rows="6"><?php echo e($faq->answer); ?></textarea>
                            </div>
...
<?php echo $__env->make('backend.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Seed Media\Growth_Master\resources\views/backend/faqs/update-faqs.blade.php ENDPATH**/ ?>