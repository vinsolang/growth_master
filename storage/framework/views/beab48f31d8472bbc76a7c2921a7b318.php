...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                <!-- File input -->
                <form action="<?php echo e(route('work.store')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-12">
                                 ...
                                 <div class="mb-3 col-12">
                                    ...
                                    <textarea name="button_text" class="form-control" id="button_text"></textarea>
                                </div>
...
<?php echo $__env->make('backend.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Seed Media\Growth_Master\resources\views/backend/howItWorks/add-work.blade.php ENDPATH**/ ?>