...
<div id="faq-container" class="max-w-5xl mx-auto p-6 bg-white text-blue-900">
    <?php $__currentLoopData = $showFAQs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="cursor-pointer">
            <button
                class="question-toggle cursor-pointer flex justify-between items-center w-full py-4 text-lg font-medium text-blue-900 focus:outline-none">
                <span class="icon-indicator mr-3 text-xl text-blue-900">
            ...
            <div
                class="content px-10 pb-4 text-blue-900 overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-in-out">
                <p>
...
<?php /**PATH D:\Seed Media\Growth_Master\resources\views/frontend/include/faqs.blade.php ENDPATH**/ ?>