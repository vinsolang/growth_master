    ...
    <div class="w-full h-auto bg-[#68875d] flex flex-col px-4 py-8 xl:px-45 xl:py-30 md:px-6 md:py-24 space-y-12">
        <div class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 gap-y-6 text-[#ffffff] font-meduim">
                ...
                <div class="space-y-2">
                    ...
                    <ul class="space-y-2 text-[14px]">
                        <li><a href="<?php echo e(route('about')); ?>">About Growth Master</a></li>
                        <li><a href="<?php echo e(route('what.is.growth')); ?>">What is Growth Master</a></li>
                ...
                <div class="space-y-2">
                    ...
                    <ul class="space-y-2 text-[14px]">
                        <li><a href="<?php echo e(route('home')); ?>#event-finan">Finance for Non-finance </a></li>
        ...
        <div class="space-y-4">
            ...
            <div class="flex flex-col lg:flex-row gap-x-8 text-[#ffffff] font-meduim text-[14px]">
                ...
                <a href="<?php echo e(route('sitemap')); ?>" class="font-bold text-center">
                    <p>Sitemap</p>
                </a>
            </div>
        </div>
