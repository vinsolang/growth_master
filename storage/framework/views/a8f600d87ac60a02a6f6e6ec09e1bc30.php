...
<?php $__env->startSection('title', 'Programs Guaranteed'); ?>
...
.program-content table th {
  ...
  <div class="space-y-10">
    ...
    <div class="md:px-0 px-4" id="program-block">
        <h1 class="text-blue-900 text-center text-3xl md:text-4xl xl:text-5xl font-bold">
            <?php echo e($getTextProgram[0]->title_program); ?>

        </h1>
        <div class="text-center mb-12 text-blue-900 text-xl md:text-2xl">
            <?php echo e($getTextProgram[0]->content_program); ?>

        </div>

        <div class="max-w-7xl mx-auto px-4 py-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php $__currentLoopData = $getProgramJob; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('program.details', $program->id)); ?>#program-details" class="group bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition duration-300">
                        <div class="relative overflow-hidden">
                            <img src="<?php echo e(asset('assets/program_guaranteed/'. $program->img_card)); ?>" class="w-full h-56 object-cover group-hover:scale-110 transition duration-500">
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Seed Media\Growth_Master\resources\views/frontend/program/job-program.blade.php ENDPATH**/ ?>