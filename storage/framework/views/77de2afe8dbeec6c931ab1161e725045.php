    ...
    <div id="eventPage" class="space-y-45">
        ...
        <div class="relative w-full h-[40vh] md:h-screen top-24">
            ...
            <!-- Background Image (NO padding!) -->
                  ...
                  <?php if(!empty($getBanner) && $getBanner[13]->title === 'per-to-per'): ?>
                    <img 
                        src="<?php echo e(asset('assets/banner/' . $getBanner[13]->image)); ?>"
            ...
            <div
                ...
                <p
                    ...
                    <?php if(!empty($getBanner) && $getBanner[13]->title === 'per-to-per'): ?>
                            <?php echo nl2br(e(value: $getBanner[13]->content)); ?>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Seed Media\Growth_Master\resources\views/frontend/sitemap/per-to-per-matoring.blade.php ENDPATH**/ ?>