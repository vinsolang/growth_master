...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl grow container-p-y">
            ...
            <div class="col-xl-12">
                <!-- File input -->
                <form action="<?php echo e(route('homecard.store')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-5 col-12">
                                    <label class="block mb-2 text-sm font-medium text-[#0F4634]">Icon</label>

                                    <div class="flex justify-between items-center">
                                        <label class="uploader flex flex-col items-center justify-center w-[200px] h-[200px]
                       border-2 border-dashed border-[#0F4634]/40 cursor-pointer bg-[#F9FAFB] hover:bg-[#F3F4F6]
                       transition relative overflow-hidden">

                                            <!-- Preview (empty for add) -->
                                            <img class="preview-image hidden absolute inset-0 m-auto w-[150px] h-[150px] object-cover"
                                                alt="preview" />
...
<?php echo $__env->make('backend.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Seed Media\Growth_Master\resources\views/backend/homeCard/add-banner.blade.php ENDPATH**/ ?>