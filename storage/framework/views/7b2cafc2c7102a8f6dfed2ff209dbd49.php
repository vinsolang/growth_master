                ...
                <form action="<?php echo e(route('banner.update', $banner->id)); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <input type="hidden" name="update_id" value="<?php echo e($banner->id); ?>">
                                <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Name</label>
                                    <input class="form-control" type="text" name="title" value="<?php echo e($banner->title); ?>" readonly />
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Title</label>
                                    <textarea class="form-control" type="text" name="name"><?php echo e($banner->name); ?></textarea>
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Content</label>
                                    <textarea name="content" id="content" class="form-control"><?php echo e($banner->content); ?></textarea>
                                </div>
                                    ...
                                    <div class="flex">
                                        <label class="uploader relative flex flex-col items-center justify-center 
                                            ...
                                            <img 
                                                ...
                                                <?php echo e($banner->image ? '' : 'hidden'); ?>"
                                                src="<?php echo e($banner->image ? asset('assets/banner/'.$banner->image) : ''); ?>"
                                            />
                                            ...
                                            <button type="button"
                                                ...
                                                <?php echo e($banner->image ? '' : 'hidden'); ?>">✕</button>
...
<?php echo $__env->make('backend.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Seed Media\Growth_Master\resources\views/backend/banner/update-banner.blade.php ENDPATH**/ ?>